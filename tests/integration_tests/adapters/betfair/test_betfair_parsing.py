...
class TestBetfairParsingStreaming:
    ...
    @staticmethod
    def test_market_definition_to_instrument_status():
        # Arrange
    ...
    @staticmethod
    def test_market_definition_to_instrument_close_price():
        # Arrange
    ...
    @staticmethod
    def test_market_definition_to_betfair_starting_price():
        # Arrange
        market_definition_close = decode(
            encode(BetfairResponses.market_definition_closed()),
            type=MarketDefinition,
    ...
    @staticmethod
    def test_market_change_bsp_updates():
...
class TestBetfairParsing:
    ...
    @staticmethod
    def test_order_side_parser_to_betfair():
