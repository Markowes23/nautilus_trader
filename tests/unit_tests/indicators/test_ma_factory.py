...
class TestMaFactory:
    @staticmethod
    def test_simple_returns_expected_indicator():
        # Arrange, Act
    ...
    @staticmethod
    def test_exponential_returns_expected_indicator():
        # Arrange, Act
    ...
    @staticmethod
    def test_hull_returns_expected_indicator():
        # Arrange, Act
    ...
    @staticmethod
    def test_weighted_returns_expected_indicator():
        # Arrange, Act
    ...
    @staticmethod
    def test_wilde_returns_expected_indicator():
        # Arrange, Act
    ...
    @staticmethod
    def test_double_exponential_returns_expected_indicator():
        # Arrange, Act
    ...
    @staticmethod
    def test_variable_index_dynamic_returns_expected_indicator():
        # Arrange, Act
