...
class TestExponentialMovingAverage:
    def setup(self):
        # Fixture Setup
        self.ema = PyExponentialMovingAverage(10)

    def test_name_returns_expected_string(self):
        # Arrange, Act, Assert
        assert self.ema.name == "PyExponentialMovingAverage"

    def test_str_repr_returns_expected_string(self):
        # Arrange, Act, Assert
        assert str(self.ema) == "PyExponentialMovingAverage(10)"
        assert repr(self.ema) == "PyExponentialMovingAverage(10)"
